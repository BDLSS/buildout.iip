...
To add TIFF capability, add the following at the end of ~/Downloads/kakadu/apps/make/Makefile-Linux-x86-64-gcc:

```bash
DEFINES += -DKDU_INCLUDE_TIFF
```

If you later get a 'undefined reference to ssse3...' error, add the following as well (at the end):
